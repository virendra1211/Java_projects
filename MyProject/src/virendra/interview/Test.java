...
public class Test {
	...
	static String treeString = "" + "(Level 1\r\n" + "    (Level 1.1\r\n"
			+ "        (Level 1.1.1)\r\n" + "        (Level 1.1.2\r\n"
			+ "            (Level 1.1.2.1)\r\n" + "            (Level 1.1.2.2)\r\n"
			+ "            (Level 1.1.2.3)\r\n" + "            (Level 1.1.2.4)\r\n"
			+ "        )\r\n" + "        (Level 1.1.3)\r\n" + "    )\r\n" + "    (Level 1.2\r\n"
	...
	public static void main(String[] args) {
		...
		int nth = 3;
		Optional<Integer> result = list.stream().sorted(Comparator.reverseOrder()).skip(nth - 1)
				.findFirst();
		...
		map.putIfAbsent("a", new AtomicInteger(0));
		AtomicInteger p = map.get("a");
		int j = p.incrementAndGet();
		p.incrementAndGet();
