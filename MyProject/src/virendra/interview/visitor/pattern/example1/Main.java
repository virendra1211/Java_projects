...
import virendra.interview.visitor.pattern.example1.items.Book;
import virendra.interview.visitor.pattern.example1.items.Electronics;
import virendra.interview.visitor.pattern.example1.items.Fruit;
import virendra.interview.visitor.pattern.example1.items.ShopItem;
import virendra.interview.visitor.pattern.example1.items.ShopItemCategory;
import virendra.interview.visitor.pattern.example1.items.Vegetable;
import virendra.interview.visitor.pattern.example1.util.BillPrinter;
