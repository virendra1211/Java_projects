...
public class Employee implements Serializable, Comparable<Employee> {
	...
	/*
	 * if student is not serialized then will get java.io.NotSerializableException:
	 * while deserializing or serializing the object
	 */
	/// private transient Student stu = new Student(); ** even when deserialize will
	/// get null
