...
public class Jdk8ExamplesStream {
	public static void main(String[] args) {
		// New DateTime methods:
			...
			System.out.println("((((");
			// peek - for debugging
			Stream.generate(Math::random).peek(x->System.out.println("Fetch " + x)).limit(10).forEach(System.out::println);
	...
	public static void streamExample() {
		...
		list.add(new Employee(11,"a1"));list.add(new Employee(12,"a2"));
		list.add(new Employee(13,"a3"));list.add(new Employee(14,"a4"));
